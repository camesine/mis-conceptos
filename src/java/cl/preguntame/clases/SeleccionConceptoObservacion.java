...
public class SeleccionConceptoObservacion {
    ...
    public SeleccionConceptoObservacion(String Enunciado, Concepto ConceptoCorrecto, Concepto Opcion1, Concepto Opcion2, Concepto Opcion3, Concepto Opcion4) {
    ...
    public SeleccionConceptoObservacion() {
        this.Enunciado = null;
