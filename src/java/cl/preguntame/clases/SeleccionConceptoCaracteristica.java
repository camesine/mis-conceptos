...
public class SeleccionConceptoCaracteristica {
    ...
    public SeleccionConceptoCaracteristica(String Enunciado, Concepto ConceptoCorrecto, Concepto Opcion1, Concepto Opcion2, Concepto Opcion3, Concepto Opcion4) {
    ...
    public SeleccionConceptoCaracteristica() {
        this.Enunciado = null;
